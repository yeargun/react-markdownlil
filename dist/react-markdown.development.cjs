...
// react-markdown.development.js
var react_markdown_development_exports = {};
__export(react_markdown_development_exports, {
  MarkdownAsync: () => $c,
  MarkdownHooks: () => ad,
  default: () => _c,
  defaultUrlTransform: () => Pb
});
module.exports = __toCommonJS(react_markdown_development_exports);
